...
describe('Text Component', () => {
  ...
  it('Text Atom shows text correctly', () => {
    const {getByTestId} = render(
      <CustomText testID="text-atom" text="Testing" />,
    );
  ...
  it('Text Atom fontSize prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" fontSize={20} />,
    );

    const element = queryByTestId('text-atom');
    const defaultStyles = element?.props.style[0];

    const fontSize = !!defaultStyles.find(
      (item: TextStyle) => item.fontSize === 20,
    );
  ...
  it('Text Atom fontWeight prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" fontWeight="Bold" />,
    );

    const element = queryByTestId('text-atom');
    const defaultStyles = element?.props.style[0];

    const fontWeight = !!defaultStyles.find(
      (item: TextStyle) => item.fontFamily === 'NotoSansJP-Bold',
    );
  ...
  it('Text Atom textColor prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" textColor="#000" />,
    );

    const element = queryByTestId('text-atom');
    const defaultStyles = element?.props.style[0];

    const textColor = !!defaultStyles.find(
      (item: TextStyle) => item.color === '#000',
    );
  ...
  it('Text Atom typography prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" typography="h4" />,
    );
  ...
  it('Text Atom textAlign prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" textAlign="justify" />,
    );
  ...
  it('Text Atom transform prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" transform="capitalize" />,
    );
  ...
  it('Text Atom underline prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" underline />,
    );
  ...
  it('Text Atom spacing prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" spacing={5} />,
    );
  ...
  it('Text Atom lineHeight prop works correctly', () => {
    const {queryByTestId} = render(
      <CustomText testID="text-atom" text="Testing" lineHeight={20} />,
    );
